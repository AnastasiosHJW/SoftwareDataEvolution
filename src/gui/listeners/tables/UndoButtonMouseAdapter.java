...
public class UndoButtonMouseAdapter extends MouseAdapter {
	...
	public UndoButtonMouseAdapter(TableData tableData, ShowDetailsComponents showDetails, GlobalManager globalManager) {
		super();
		this.tableData = tableData;
		this.showDetails = showDetails;
		this.globalManager = globalManager;
		tableManager = globalManager.getTableManager();
		clusterManager = globalManager.getClusterManager();
	}
